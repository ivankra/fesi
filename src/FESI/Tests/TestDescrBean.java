...
public class TestDescrBean {
    ...
    private int[] intArray = new int [] { 1 , 2, 3, 4, 5 }; // Magic value, checked by test program
    private int[] intIndexed = new int [] { 11 , 12, 13, 14, 15 }; // Magic value, checked by test program
    ...
    public String toString() {
        StringBuffer v = new StringBuffer("TestDescrBean: intValue="+intValue+", intArray=[");
